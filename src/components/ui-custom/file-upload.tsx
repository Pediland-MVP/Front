...
export const FileUpload = ({
  ...
  return (
    <div
      className={cn(
        className,
        "hover:border-primary relative mt-1 rounded-lg border-2 bg-white duration-300",
      )}
      {...getRootProps()}
    >
      {isUploading && (
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-20 text-center text-sm font-light text-neutral-400 dark:text-neutral-400">
            {t("description")}
          </p>
          <div className="relative mx-auto mt-10 w-full max-w-xl">
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute inset-0 z-30 mx-auto mt-4 flex w-full max-w-[8rem] items-center justify-center rounded-md border border-gray-200 bg-transparent opacity-0"
              ></motion.div>
            )}
          </div>
        </div>
