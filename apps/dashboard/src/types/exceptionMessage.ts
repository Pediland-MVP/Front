export type ERROR_CODES =
  ...
  | 'COMMERCE_KIND_LOCKED'
  | 'COMMERCE_PRODUCT_NOT_FOUND'
  | 'COMMERCE_OPTION_LIMIT_EXCEEDED'
  | 'COMMERCE_VARIANT_LIMIT_EXCEEDED'
  | 'COMMERCE_INVALID_SELECTION'
  | 'COMMERCE_CATEGORY_IN_USE'
  | 'COMMERCE_CATEGORY_CYCLE'
  | 'COMMERCE_IMPORT_INVALID_FILE'
  | 'COMMERCE_IMPORT_JOB_NOT_FOUND';
