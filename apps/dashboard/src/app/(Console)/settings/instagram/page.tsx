...
export default function Page() {
  ...
  if (permissionsLoading) {
    return (
      <div className="_instagram-page flex h-[300px] flex-1 items-center justify-center rounded-t-3xl bg-white md:rounded-t-none md:rounded-b-xl">
  ...
  return (
    <div className="_instagram-page flex-1 rounded-t-3xl bg-white md:rounded-t-none md:rounded-b-xl">
      <div className="h-full border-gray-100 px-4 py-5 md:pt-0">
        ...
        {atLimit && <p className="text-muted-foreground mb-3 text-xs">{t('limitReached')}</p>}
