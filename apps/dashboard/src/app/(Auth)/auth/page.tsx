  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="space-y-5 px-10 sm:max-w-sm">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="min-w-[240px] space-y-3">
            <FormField
        ...
        <div className="flex justify-center">
          <GoogleLogin
            onSuccess={(credentialResponse) => handleGoogleSignIn(credentialResponse.credential)}
        ...
        <p className="text-muted-foreground text-center text-[13px]">
          {t.rich('terms_and_conditions_message', {
            a: (chunks) => (
              <a
                href={
                  locale === 'fa' ? 'https://befroosh.app/terms' : 'https://befroosh.app/en/terms'
                }
                target="_blank"
