...
import { CopyIcon, PlugIcon, Trash2Icon, TvMinimalPlayIcon } from 'lucide-react';
    ...
    if (
      ...
      return (
        <div className="mt-7 flex w-full max-w-md flex-col items-center justify-center">
          ...
          <div>
            <PlugsIcon size={46} weight="duotone" className="text-destructive mx-auto" />
          ...
          <HelpMeDialog
            ...
            noAbsolute
          >
            <Button type="button" variant="link" size="lg" className="text-muted-foreground mt-3">
          ...
          <div className="mt-4 flex w-full items-center justify-center gap-x-1">
            <Button
              ...
              className="hover:text-500 w-1/2 text-red-500 sm:flex-1"
              variant="outline"
            >
          ...
          <ButtonLoading
            ...
            className="bg-primary mt-2 w-full text-white hover:bg-purple-500 sm:flex-1"
          >
            <PlugIcon />
            {t('relogin')}
          </ButtonLoading>
