import { FormControl, FormField, FormItem, FormLabel, Input, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui";
  ...
  return (
    <div className="flex justify-center items-center gap-x-2">
      <FormField
        ...
        render={({ field }) => (
          <Select
            onValueChange={delayUnitChangeHandler}
      ...
      <FormField
        ...
        render={({ field, fieldState: { invalid } }) => (
          <FormItem>
            <FormControl>
              <Input {...field} onInput={delayMsInputHandler} onChange={(e) => delayMsChangeHandler(+e.target.value)} type="text" value={field.value / timeUnits[delayUnit]?.zarib}  defaultValue={field.value / timeUnits[delayUnit]?.zarib} />
            </FormControl>
            {
