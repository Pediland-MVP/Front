...
export default function AdminsTable({
  ...
  const createForm = useForm<CreateValues>({
    ...
    defaultValues: { firstname: "", lastname: "", username: "", password: "", role: "kam", telegramId: "" },
  });
          ...
          <DialogContent className="max-w-md" dir="rtl">
            ...
            <Form {...createForm}>
              <form onSubmit={createForm.handleSubmit(handleCreate)} className="space-y-4">
                ...
                <FormField control={createForm.control} name="telegramId" render={({ field }) => (
                  <FormItem>
              ...
              <form onSubmit={editForm.handleSubmit(handleEdit)} className="space-y-4">
                ...
                <FormField control={editForm.control} name="password" render={({ field }) => (
                  <FormItem>
                    ...
                    <div className="flex gap-2">
                      <FormControl><Input {...field} className="font-mono" placeholder={t("passwordPlaceholder")} /></FormControl>
                      <Button
                        type="button"
                        variant="outline"
                        size="sm"
                ...
                <FormField control={editForm.control} name="telegramId" render={({ field }) => (
                  <FormItem>
                    <FormLabel>{t("telegramIdOptional")}</FormLabel>
                    <FormControl><Input {...field} /></FormControl>
                    <FormMessage />
