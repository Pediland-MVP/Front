        ...
        {error && (
          <div className="scrollbar-thin flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto p-4">
            ...
            <div>
              ...
              <pre
                className="scrollbar-thin max-h-64 overflow-auto rounded-lg bg-slate-50 p-3 text-xs"
                dir="ltr"
              >
