...
export const ReturnContent = ({
  ...
  switch (type) {
    case AutomationContentTypesEnum.TEXT:
      return <TextContent control={control} mode={mode} index={index} apiClient={apiClient} />;

    case AutomationContentTypesEnum.INSTAGRAM_POST:
      return <IGPostContent mode={mode} index={index} apiClient={apiClient} />;
    ...
    case AutomationContentTypesEnum.QUESTION:
      return <QuestionContent control={control} mode={mode} index={index} apiClient={apiClient} />;

    case AutomationContentTypesEnum.VITRIN:
      return <VitrinContent index={index} mode={mode} control={control} apiClient={apiClient} />;
