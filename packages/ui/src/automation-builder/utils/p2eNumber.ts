// packages/ui/src/automation-builder/utils/p2eNumber.ts
// Copied from apps/dashboard/src/utils/p2eNumber.ts (each app keeps its own copy of this
// utility per CLAUDE.md §18; DelayContent.tsx needs it and is now shared code).
