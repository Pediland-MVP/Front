...
function DialogStyledTrigger({ ...props }: React.ComponentProps<typeof DialogPrimitive.Trigger>) {
  return <DialogPrimitive.Trigger data-slot="dialog-trigger" {...props} />;
}

function DialogStyledPortal({ ...props }: React.ComponentProps<typeof DialogPrimitive.Portal>) {
  return <DialogPrimitive.Portal data-slot="dialog-portal" {...props} />;
}

function DialogStyledClose({ ...props }: React.ComponentProps<typeof DialogPrimitive.Close>) {
  ...
  return (
    <DialogStyledPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 flex max-h-[90dvh] w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] flex-col overflow-hidden rounded-lg border shadow-lg duration-200 sm:max-w-lg',
          className,
        )}
        {...props}
      >
...
function DialogStyledHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
...
function DialogStyledBody({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
...
function DialogStyledFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
