          ...
          <div className="flex flex-1 flex-wrap gap-2 overflow-hidden">
            {selectedAccounts.length === 0 ? (
              ...
              selectedAccounts.map((acc) => (
                ...
                >
                  <AccountAvatar account={acc} size={18} />@{acc.username ?? acc.name}
                </span>
              ))
            )}
          </div>
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0 flex-1 text-start">
                  <div className="truncate leading-tight font-semibold">{acc.name}</div>
                  <div className="mt-0.5 truncate text-xs text-gray-400">@{acc.username ?? ''}</div>
                </div>
                <div
                  className={cn(
