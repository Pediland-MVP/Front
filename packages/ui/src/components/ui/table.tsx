...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('bg-violet-50 [&_tr]:border-b [&_tr]:hover:bg-inherit', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'text-foreground h-12 px-3 align-middle font-medium whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
      className,
    )}
    {...props}
  />
