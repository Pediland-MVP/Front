...
export function DatePicker({
  ...
  const formatted = date ? dayjs(date).calendar('jalali').format('YYYY/MM/DD') : '';
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          className={cn(
            buttonClassName || '',
            `data-[state=open]:border-primary data-[empty=true]:text-muted-foreground focus:border-primary flex items-center justify-start text-sm`,
          )}
        >
          <CalendarIcon />
