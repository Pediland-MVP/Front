            ...
            {!files.length && (
              ...
              >
                {isDragActive ? (
                  ...
                  <UploadSimple className="h-4 w-4 text-neutral-600 dark:text-neutral-300" />
                )}
              </motion.div>
            )}
...
const ImageGrid = ({ images }: {images: string[]}) => {
  ...
  return (
    <div className={`grid ${gridColsClass} gap-4 mb-4 place-items-center justify-center`}>
      {images.map((image, index) => (
        <div key={index} className="relative aspect-square rounded-md overflow-hidden h-40 w-40">
          <Image
            src={image}
