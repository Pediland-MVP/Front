    ...
    return (
        <div className="w-full flex flex-col justify-start items-center">
            <div className="w-full max-w-[320px] flex flex-col justify-center items-center" >
                ...
                <Video controls loop playsInline className="mb-4" variant="bordered" src={WizardVideoLinks.Automations.table.video} poster={WizardVideoLinks.Automations.table.poster} shape="vertical" />
