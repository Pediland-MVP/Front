    ...
    return (
        <div className="_accounts-error-page flex justify-center items-center h-full">
            <div className="flex flex-col items-center gap-5">
                ...
                <p className="text-gray-600 text-center">{t("errorOccurred")}<br />{t("goTo")} <Link href="/console/settings/instagram" className="text-blue-600 hover:text-primary">{t("accounts")}</Link> {t("goToEnd")}</p>
            </div>
        </div>
    );
}   